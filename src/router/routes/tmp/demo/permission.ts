      ...
      children: [
        {
          path: 'page',
          name: 'FrontPageAuth',
          component: () => import('/src/views/demo/permission/front/index.vue'),
          meta: {
        ...
        },
        {
          path: 'btn',
          name: 'FrontBtnAuth',
          component: () => import('/src/views/demo/permission/front/Btn.vue'),
          meta: {
        ...
        },
        {
          path: 'auth-pageA',
          name: 'FrontAuthPageA',
          component: () => import('/src/views/demo/permission/front/AuthPageA.vue'),
          meta: {
        ...
        },
        {
          path: 'auth-pageB',
          name: 'FrontAuthPageB',
          component: () => import('/src/views/demo/permission/front/AuthPageB.vue'),
          meta: {
      ...
      children: [
        {
          path: 'page',
          name: 'BackAuthPage',
          component: () => import('/src/views/demo/permission/back/index.vue'),
          meta: {
        ...
        },
        {
          path: 'btn',
          name: 'BackAuthBtn',
          component: () => import('/src/views/demo/permission/back/Btn.vue'),
          meta: {
