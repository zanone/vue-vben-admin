  ...
  children: [
    {
      path: 'icon',
      name: 'IconDemo',
      component: () => import('/src/views/demo/feat/icon/index.vue'),
      meta: {
    ...
    },
    {
      path: 'ws',
      name: 'WebSocket',
      component: () => import('/src/views/demo/feat/ws/index.vue'),
      meta: {
    ...
    },
    {
      ...
      name: 'RequestDemo',
      // @ts-ignore
      component: () => import('/src/views/demo/feat/request-demo/index.vue'),
      meta: {
    ...
    },
    {
      ...
      name: 'SessionTimeout',
      component: () => import('/src/views/demo/feat/session-timeout/index.vue'),
      meta: {
    ...
    },
    {
      path: 'print',
      name: 'Print',
      component: () => import('/src/views/demo/feat/print/index.vue'),
      meta: {
    ...
    },
    {
      path: 'tabs',
      name: 'TabsDemo',
      component: () => import('/src/views/demo/feat/tabs/index.vue'),
      meta: {
      ...
      children: [
        {
          path: 'detail/:id',
          name: 'TabDetail',
          component: () => import('/src/views/demo/feat/tabs/TabDetail.vue'),
          meta: {
      ...
      children: [
        {
          ...
          component: () => import('/src/views/demo/feat/breadcrumb/FlatList.vue'),
          meta: {
        ...
        },
        {
          ...
          component: () => import('/src/views/demo/feat/breadcrumb/FlatListDetail.vue'),
          meta: {
        ...
        },
        {
          ...
          component: () => import('/src/views/demo/feat/breadcrumb/ChildrenList.vue'),
          meta: {
          ...
          children: [
            {
              ...
              component: () => import('/src/views/demo/feat/breadcrumb/ChildrenListDetail.vue'),
              meta: {
...

    {
      ...
      component: () => import('/src/views/demo/feat/context-menu/index.vue'),
      meta: {
    ...
    },
    {
      path: 'download',
      name: 'DownLoadDemo',
      component: () => import('/src/views/demo/feat/download/index.vue'),
      meta: {
    ...
    },
    {
      ...
      component: () => import('/src/views/demo/feat/click-out-side/index.vue'),
      meta: {
    ...
    },
    {
      path: 'img-preview',
      name: 'ImgPreview',
      component: () => import('/src/views/demo/feat/img-preview/index.vue'),
      meta: {
    ...
    },
    {
      path: 'copy',
      name: 'CopyDemo',
      component: () => import('/src/views/demo/feat/copy/index.vue'),
      meta: {
    ...
    },
    {
      path: 'msg',
      name: 'MsgDemo',
      component: () => import('/src/views/demo/feat/msg/index.vue'),
      meta: {
    ...
    },
    {
      path: 'watermark',
      name: 'WatermarkDemo',
      component: () => import('/src/views/demo/feat/watermark/index.vue'),
      meta: {
    ...
    },
    {
      path: 'ripple',
      name: 'RippleDemo',
      component: () => import('/src/views/demo/feat/ripple/index.vue'),
      meta: {
    ...
    },
    {
      path: 'full-screen',
      name: 'FullScreenDemo',
      component: () => import('/src/views/demo/feat/full-screen/index.vue'),
      meta: {
    ...
    },
    {
      path: '/error-log',
      name: 'ErrorLog',
      component: () => import('/src/views/sys/error-log/index.vue'),
      meta: {
      ...
      children: [
        {
          path: 'customExport',
          name: 'CustomExport',
          component: () => import('/src/views/demo/excel/CustomExport.vue'),
          meta: {
        ...
        },
        {
          path: 'jsonExport',
          name: 'JsonExport',
          component: () => import('/src/views/demo/excel/JsonExport.vue'),
          meta: {
        ...
        },
        {
          path: 'arrayExport',
          name: 'ArrayExport',
          component: () => import('/src/views/demo/excel/ArrayExport.vue'),
          meta: {
        ...
        },
        {
          path: 'importExcel',
          name: 'ImportExcel',
          component: () => import('/src/views/demo/excel/ImportExcel.vue'),
          meta: {
    ...
    },
    {
      path: 'testTab/:id',
      name: 'TestTab',
      component: () => import('/src/views/demo/feat/tab-params/index.vue'),
      meta: {
      ...
      children: [
        {
          path: 'sub1',
          name: 'TestParam_1',
          component: () => import('/src/views/demo/feat/menu-params/index.vue'),
          meta: {
